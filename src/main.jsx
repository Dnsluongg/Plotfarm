    ...
    <div className="app">
      <aside className="sidebar">
        ...
        <div className="sidebarBottom">
          <div className="userBox"><div className="avatar">A</div><div><b>{user.name}</b><small>{user.role}</small></div></div>
          <button className="logout"><LogOut size={17}/> Logout</button>
        </div>
      </aside>
      ...
      <main className="main">
        <header className="topbar">
          ...
          <div className="headerActions">
            ...
            <div className="miniUser"><div className="avatar small">A</div><span>{user.name}</span></div>
          </div>
        </header>
